...
const Result = () => {
    ...
    return (
        <div className="mx-auto max-w-1xl sm:px-6 sm:py-10 lg:px-8">
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 xl:gap-x-8">
                {products.map((product) => (
                    <a key={product.id} href={product.href} className="group">
                        <h3 className="mt-4 text-sm font-bold text-gray-700 h-20">{product.name}</h3>
